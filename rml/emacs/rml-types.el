...
(defvar rml-types-location-re nil "Regexp to parse *.rannot files.

Annotation files *.rannot may be generated with the \"-dtypes\" option 
of rmlc and rmlopt. 
...
Their format is:
  ...
  filename is a string with the lexical conventions of Reactive-ML
...
(defun rml-types-show-type (arg)
  "Show the type of expression or pattern at point.
   ...
   temporarily highlighted.  Its type is highlighted in the .rannot
...
;  (type-start . type-end)  address of the annotation in the .rannot file
